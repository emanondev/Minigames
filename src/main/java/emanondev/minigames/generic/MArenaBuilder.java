...
public abstract class MArenaBuilder {
    ...
    protected void spawnParticleBoxFaces(Player p, Particle particle, BoundingBox box) {
        spawnParticleBoxFaces(p,particle,box,null);
    }
    ...
    protected void spawnParticleBoxFaces(Player p, Particle particle, BoundingBox box, Object data) {
        markFaces(p, particle, box.getMin(), box.getMax().add(new Vector(-1, -1, -1)), data);
    }
    ...
    private void markFaces( Player p, Particle particle, Vector min, Vector max,Object data) {
