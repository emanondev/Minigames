...
public class RunRaceWinFirstEvent extends ARaceWinEvent<RunRaceGame> {
    ...
    public RunRaceWinFirstEvent(@NotNull ARaceTeam<RunRaceGame> team, @NotNull Player lineCutter, @NotNull Set<Player> winners) {
