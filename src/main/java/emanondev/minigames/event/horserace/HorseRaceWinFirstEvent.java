...
public class HorseRaceWinFirstEvent extends ARaceWinEvent<HorseRaceGame> {
    ...
    public HorseRaceWinFirstEvent(@NotNull ARaceTeam<HorseRaceGame> team, @NotNull Player lineCutter, @NotNull Set<Player> winners) {
