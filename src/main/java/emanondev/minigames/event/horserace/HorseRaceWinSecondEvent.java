...
public class HorseRaceWinSecondEvent extends ARaceWinEvent<HorseRaceGame> {
    ...
    public HorseRaceWinSecondEvent(@NotNull ARaceTeam<HorseRaceGame> team, @NotNull Player lineCutter, @NotNull Set<Player> winners) {
