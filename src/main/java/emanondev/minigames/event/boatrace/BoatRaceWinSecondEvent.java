...
public class BoatRaceWinSecondEvent extends ARaceWinEvent<BoatRaceGame> {

    private static final HandlerList HANDLERS_LIST = new HandlerList();

    public BoatRaceWinSecondEvent(@NotNull ARaceTeam<BoatRaceGame> team, @NotNull Player lineCutter, @NotNull Set<Player> winners) {
